...
class Template
{
     ...
     * @var array
     */
    private static $override_templates_list = [];
     ...
     * @var string
     */
    protected $filter_prefix = 'wecoder-crp';
     ...
     * @var string
     */
    protected $theme_template_directory = 'template-parts';
     ...
     * @var string
     */
    protected $plugin_directory = WC_REGISTRATION_POPUP_DIR;
    ...
    {
       // add_filter('woocommerce_locate_template', [$this, 'intercept_wc_template'], 1, 3);
        $this->init();
    }
    ...
    private static function get_template_default_path()
    {
        ...
        return plugin_dir_path(__DIR__) . 'woocommerce/';
    }
    ...
    {
        // Setup templates map
        self::$override_templates_list = [
            'checkout/form-login.php' => 'checkout/form-login.php',
        ];
    ...
    public static function override($template, $template_name, $template_path)
    {
        ...
        if (!array_key_exists($template_name, self::$override_templates_list)) {
            return $template;
        }
        ...
        return wc_locate_template(
            self::$override_templates_list[$template_name],
